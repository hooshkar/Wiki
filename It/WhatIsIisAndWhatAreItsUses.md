...
با استفاده از IIS Web Farm، می‌توانید زیرساختی مقیاس‌پذیر و مطمئن برای وب‌سایت‌های خود ایجاد کنید. این زیرساخت امکان میزبانی وب‌سایت‌های پرترافیک را روی چندین سرور IIS فراهم می‌کند و از ویژگی‌های تعادل بار و مسیریابی درخواست‌ها (ARR) بهره می‌برد. متعادل‌کننده بار، ترافیک را با استفاده از الگوریتم‌های خاص بین سرورها پخش کرده و ARR بهترین سرور را برای پاسخ به هر درخواست انتخاب می‌کند. همچنین، IIS Web Farm قابلیت مدیریت ترافیک را به صورت داینامیک از طریق اضافه یا حذف سرورها دارد.
