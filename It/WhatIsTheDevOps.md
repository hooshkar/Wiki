...
همانطور که در فرآیند عملکرد DevOps مشاهده کرده‌اید، برای استفاده از آن نیاز به استفاده از ابزارهای خاصی داریم که به عنوان ابزارهای DevOps شناخته می‌شوند. این ابزارها از بخش های زیر تشکیل شده‌اند:
...
مهندس DevOps یک متخصص فناوری اطلاعات (IT) است که با تیم‌های توسعه نرم‌افزار، برنامه‌نویسان، اپراتورهای سیستم و سایر اعضای حوزه IT در ارتباط قرار می‌گیرد. برای اجرای وظایفش، مهندس دواپس باید به مهارت‌های فنی (مهارت‌های سخت) بالایی دست یابد. همچنین داشتن مهارت‌، او را در برقراری ارتباط و همکاری با تیم‌های توسعه، عملیات و تست موثرتر می‌سازد.
