...
مزایا | معایب
------------ | -------------
به مدیران اجازه داده می شود تا مدیریت کنند (برنامه ریزی و کنترل) | می تواند منجر به ایجاد مقادیر زیادی از موجودی شود
دانش بالایی در رابطه با زمان های تولید و جریان مواد نیاز است. |  می تواند موجب ایجاد مقادیر زیادی از خرابی شود، قبل از آنکه منشا خرابی آشکار شود
می تواند به مقادیر بهینه در خرید و تولید بیانجامد. |  جریان مواد موثری باید برقرار باشد.
اجازه می دهد که مونتاژهای بزرگ و پیچیده برنامه ریزی شوند. چون که زیر مونتاژها و قطعات مورد نیاز تنها براساس نیاز به بخش تولیدی مربوطه می رسند | نیاز به داده ها و بانک های اطلاعاتی گسترده و بزرگ دارد
...
مزایا | معایب
------------ | -------------
مقادیر مشخص و دانسته از موجودی در دست محصولات پایانی | هرکاری ممکن است تبدیل به یک سفارش پر استرس شود
کارگران تنها وقت و مواد اولیه را بر آنچه واقعا مورد نیاز است متمرکز می کنند |  سیستم تولیدی باید کاملا متعادل باشد
کیفیت باید در سطح بالایی باشد، هر قطعه ای باید درست و صحیح به جایی که تعلق دارد ارسال شود وگرنه بازخورد خرابی داده می شود |  زمان های راه اندازی به شدت بر مقدار محصول خروجی تاثیر می گذارند
مالیات حقوق | هر مشکلی می تواند به نارضایتی مشتری (چه داخلی و چه خارجی) تبدیل شود
