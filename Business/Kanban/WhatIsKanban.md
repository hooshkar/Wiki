...
<details>
  ...
  <ul>
    ...
    <li> بورد فیزیکی کانبان </li>
   <li>بورد دیجیتالی کانبان</li>
    ...
    <li>روش های مختلف برنامه ریزی تولید با استفاده از کانبان</li>
    <ul>
      <li>کانبان کارتی</li>
      <li>صندوق کانبان</li>
      <li>کار پیوسته در جریان (Constant Flow of Work) یا CFW</li>
    </ul>
    <li>مزایای روش استفاده از کانبان</li>
    <li>معایب کانبان</li>
    <li>چرا باید از کانبان استفاده کنیم؟</li>
  </ul>
</details>
...
کانبان، عبارتی ژاپنی است که از دو کلمه "Kan" (به معنی "دیدن") و "Ban" (به معنی "کارت") تشکیل شده است. نخستین بار توسط تویوتا وارد فضای مدیریت شد. در واقع کانبان شبیه Board عمومی یا تابلویی است که برای همه قابل مشاهده است. 
...
تخته کانبان معمولاً شامل ستون‌ها و سطرهای مختلف است. ساده‌ترین شکل این تخته‌ها شامل سه ستون است که به شرح زیر است:
...
### بورد فیزیکی کانبان
بوردهای فیزیکی کانبان، شکل ابتدایی‌ترین این نوع بوردها هستند که تیم‌ها برای نمایش کارها از کاغذ یادداشت چسبی و برای چسباندن آنها از وایت‌بورد استفاده می‌کنند. در این بوردها، مراحل کار به صورت ستون‌هایی نمایش داده می‌شوند و کاغذهای یادداشت چسبی از یک ستون به ستون بعدی منتقل می‌شوند.

### بورد دیجیتالی کانبان

بورد دیجیتال کانبان به عنوان یک راه‌حل نرم‌افزاری برای نمایش مراحل گردش کار شناخته می‌شود که در مقایسه با ابزارهای مشابه فیزیکی، کارآمد بیشتری دارد. این نوع بوردهای کانبان، علاوه بر تسهیل همکاری تیمی، امکان مشاهده پیشرفت کار را از هر جایی برای اعضای تیم فراهم می‌کنند.

برخی از بوردهای دیجیتال کانبان بسیار انعطاف‌پذیر بوده و به مدیران اجازه می‌دهند تا چندین گردش کار را ردیابی و کار خود را در دسته‌های مختلف سازماندهی کنند. در صنایع و تیم‌های مختلف، نمونه‌های متعددی از بوردهای کانبان استفاده می‌شود، هرکدام با پیشینه‌ها و کاربردهای مختلف.
