...
<details>
  ...
  <ul>
    <li>تعریف سیستم تولید Just in time</li>
    <li>سیستم برنامه ریزی و کنترل تولید فشاری Push SYS</li>
    <li>سیستم برنامه ریزی و کنترل تولید کششی Pull SYS</li>
    <li>تفاوت سیستم برنامه ریزی و کنترل تولید فشاری و کششی</li>
    <li>مزایا و معایب سیستم تولید فشاری</li>
    <li>مزایا و معایب سیستم تولید کششی</li>
    <li>اصول تولید به هنگام</li>
    <li>کایزن (Kaizen): بهبود مستمر و ترویجی</li>
    <li>از بین بردن تلفات (MUDA, MURI, MURA)</li>
    <li>سایر اصول به هنگام</li>
    <li>کارت کانبان (Kanban)</li>
    <li>تابلو آندون (Andon)</li>
    <li>زمان تکت (Takt Time)</li>
  </ul>
</details>
...
[تفاوت سیستم برنامه ریزی و کنترل تولید فشاری و کششی]: #تفاوت-سیستم-برنامه-ریزی-و-کنترل-تولید-فشاری-و-کششی
[مزایا و معایب سیستم تولید فشاری]: #مزایا-و-معایب-سیستم-تولید-فشاری
[مزایا و معایب سیستم تولید کششی]: #مزایا-و-معایب-سیستم-تولید-کششی
[اصول تولید به هنگام]: #اصول-تولید-به-هنگام
[کایزن (Kaizen): بهبود مستمر و ترویجی]: #کایزن-kaizen-بهبود-مستمر-و-ترویجی
[از بین بردن تلفات (MUDA, MURI, MURA)]: #از-بین-بردن-تلفات-muda-muri-mura
[سایر اصول به هنگام]: #سایر-اصول-به-هنگام
[کارت کانبان (Kanban)]: #کارت-کانبان-kanban
