...
<details>
  ...
  <ul>
    ...
    <li>استانداردهای قبل از BPMN
      <ul>
        <li>EPC (Event-driven Process Chain)</li>
        <li>UML (Unified Modeling Language)</li>
        <li>IDEF (Integrated Definition)</li>
        <li>Petri Nets</li>
        <li>Flowchart</li>
      </ul>
    </li>
    <li>تفاوت BPM با BPMN چیست؟</li>
    <li>هدف مدلسازی مدیریت فرآیند کسب و کار چیست؟</li>
    <li>مزایای BPMN چیست؟</li>
...
![BPMN چیست؟](./Images/WhatIsBpmn.webp)
...
![Business Process Model and Notation چیست؟](./Images/BPMN.webp)
...
**2. بهینه‌سازی فرآیندها:** با استفاده از مدل‌سازی، می‌توان به سادگی نقاط ضعف و قوت فرآیندها را شناسایی کرده و بهینه‌سازی آن‌ها را انجام داد. این کار می‌تواند به کاهش هزینه‌ها، افزایش بهره‌وری، بهبود کیفیت خدمات و محصولات سازمان منجر شود.
...
در واقع BPMN به عنوان یک استاندارد مدلسازی فرآیند کسب و کار، در  <a href="https://www.hooshkar.com/Software/Fennec" target="_blank">نرم افزارهای ERP
...
- BPMN برای تحلیل، مستندسازی و بهبود فرآیندهای کسب و کار در سازمان‌ها استفاده می‌شود و این امکان را به شما می‌دهد تا فرآیندهای کاری را به صورت بصری و با استفاده از سمبل‌های گرافیکی نشان دهید.

 - BPMS برای طراحی، اجرا، مانیتورینگ و بهینه‌سازی فرآیندهای کاری استفاده می‌شود. ابزاری است که به سازمان‌ها کمک می‌کند تا فرآیندهای کاری خود را به صورت خودکار و بهینه‌سازی شده اجرا کنند.

- بنابراین، BPMN  یک زبان ترسیمی برای نمایش فرآیندهای کاری است،
 در حالی که BPMS یک سیستم نرم‌افزاری است که برای مدیریت فرآیندهای کاری بهبود یافته استفاده می‌شود.
...
![تفاوت بین bpmn و bpms](./Images/BpmsVsBpmn.webp)
---
