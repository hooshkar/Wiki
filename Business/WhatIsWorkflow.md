...
گردش کار (Workflow) یکی از مفاهیم اساسی در مدیریت فرایندها و عملیات سازمان‌ها است که در دنیای کسب و کار اهمیت بسیاری دارد. این مفهوم به تعریف، اجرا و اتوماسیون فرایندهای تجاری اشاره دارد که در آن، وظایف، اطلاعات و اسناد برای انجام اقدامات خاص از یک نفر به نفر دیگر منتقل می‌شوند. 

با توجه به اینکه سازمان‌ها با چالش‌های مختلفی در مدیریت عملیات و هماهنگی بین افراد و سیستم‌ها روبه‌رو هستند، استفاده از گردش کار به منظور بهبود بهره‌وری، شفافیت، کاهش زمان واکنش و بهبود پاسخگویی، امری ضروری به نظر می‌رسد.
