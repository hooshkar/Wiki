...
در این مقاله به معرفی ERP، تاریخچه و اهمیت آن خواهیم پرداخت تا با این سیستم مهم آشنا شوید.
...
در سال 1975، تقریباً همه شرکت‌های بزرگ از نرم‌افزار MRP برای مدیریت ارتباط با مشتری و کنترل فرآیندهای استراتژیک استفاده می‌کردند. 
