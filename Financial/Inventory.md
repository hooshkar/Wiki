...
فایفو، یکی از معروف‌ترین سیستم‌ها است که تقریبا همه‌ی ما با آن آشنایی داریم. 
...
### سیستم LiFo
لایفو، کاملا برعکس سیستم فایفو است. در این سیستم، کالای جدیدتر بر کالای قدیمی اولویت دارد و زودتر خارج می‌شود. سیستم لایفو بیشتر برای محصولات الکترونیکی کاربرد دارد تا کالاهایی با تکنولوژی جدیدتر، جایگزین کالاهای قدیمی شوند.
