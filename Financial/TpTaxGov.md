...
<details>
  ...
  <ul>
    ...
    <li>مقایسه قیمت نرم افزار های سامانه مودیان</li>
  </ul>
</details>
...
### مقایسه قیمت نرم افزار های سامانه مودیان
...
لوگو  |  نرم افزار | ویژگی ها | قیمت (تومان)
 ------------ | -------------  | ------------- | -------------
![هوشکار پرداز](./Images/Hooshkar.webp) | نرم افزار واسط سامانه مودیان سایان | بدون وابستگی به ماژول های دیگر، تهیه گزارش های دلخواه و یکپارچه، ارسال مستقیم و نامحدود فاکتورها، دریافت گواهی امضا الکترونیک به صورت اتومات | 8.000.000
![هوشکار پرداز](./Images/Sepidar.webp) | نرم افزار سامانه مودیان سپیدار | وابستگی به ماژول های دیگر نظیر سیستم حسابداری، دریافت و پرداخت، مشتریان و فروش، انبار بازرگانی و ارسال مستقیم فاکتور | 74,151,000 
![هوشکار پرداز](./Images/HesabdarApp.webp) | نرم افزار سامانه مودیان حسابدار اپ | مدیریت بازگشت، ابطال و اصلاح فاکتورها در عملیات فروش، پشتیبانی، آموزش و بروزرسانی رایگان  | 4,200,000 
